 ...
 * Copyright 2018 francitoshi@gmail.com
 *
...
public class Base58
{
     ...
     * @throws FormatException if the given string is not a valid base58
     * string
     */
    ...
    public static byte[] decodeChecked(String input) throws FormatException 
    {
        ...
        if (decoded.length < 4)
        {
            throw new FormatException.InvalidDataLength("Input too short: " + decoded.length);
        }
    ...
    public static class FormatException extends Exception
    {
        ...
        public static class InvalidCharacter extends FormatException
        {
            ...
            {
                super("invalid character "+c+" at index "+i);
            }
        }

        public static class InvalidDataLength extends FormatException
        {
        ...
        public static class InvalidChecksum extends FormatException
        {
