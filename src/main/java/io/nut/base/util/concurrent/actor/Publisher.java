 ...
 * {@link #publish(Object)} delivers to the entry's current subscribers, and
...
public class Publisher<T> implements AutoCloseable
{
    ...
    /**
     * Publishes an event to all current subscribers of the publisher's tag.
     *
    ...
    /**
     * Closes this publisher: any further {@link #publish(Object)} throws an
