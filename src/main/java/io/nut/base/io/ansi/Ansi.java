 ...
 * escape sequences</a>.
 * 
 * copied from https://github.com/jline/jline3/blob/master/jansi-core/src/main/java/org/jline/jansi/Ansi.java
 *
 * @since 1.0
 */
public class Ansi implements Appendable
{
     ...
     * <a href="https://en.wikipedia.org/wiki/ANSI_escape_code#CSI_sequences">CSI
     * sequence J and K</a>)
     *
    ...
    /**
     * Moves the cursor to row n, column m. The values are 1-based. Any values
     * less than 1 are mapped to 1.
     *
    ...
    /**
     * Moves the cursor to column n. The parameter n is 1-based. If n is less
     * than 1 it is moved to the first column.
     *
    ...
    /**
     * Moves the cursor down. If the parameter y is negative it moves the cursor
     * up.
     *
    ...
    /**
     * Moves the cursor left. If the parameter x is negative it moves the cursor
     * right.
     *
     ...
     * right if x is positive, left if negative and down if y is positive and up
     * if negative.
     *
     ...
     * parameter n is negative it moves the cursor to the beginning of the n-th
     * line above.
     *
