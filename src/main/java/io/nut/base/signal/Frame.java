...
public class Frame
{
    ...
    private static final byte[] EMPTY_BYTES = Empty.BYTES;
    ...
    private byte[] create(byte flags, char src, char dst, char id, byte[] payload)
    {
        ...
        int crc16 = Checksums.crc16(frame, 0, HEADER_SIZE + len);
    ...
    public int check(byte[] frame)
    {
        ...
        int expected = Checksums.crc16(frame, 0, HEADER_SIZE + payloadLen);
