...
public class RealConsoleTest
{
    ...
    /**
     * Test of readLine method, of class RealConsole.
     */
    @Test
    @Timeout(1)
    public void testReadLine_String_ObjectArr()
    {
        RealConsole instance = getInstance();
        instance.addLine("1");
        instance.addLine("2");
        instance.addLine("3");
    ...
    /**
     * Test of readPassword method, of class RealConsole.
     */
    @Test
    @Timeout(1)
