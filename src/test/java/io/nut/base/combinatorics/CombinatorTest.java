...
public class CombinatorTest
{
    ...
    /**
     * Test of run method, of class Combinator.
     */
    @Test
    public void testRun()
    {
        {
            Integer[] elements = { 1 };
            Combinator<Integer> a = new Combinator<>(elements);
        ...
        {
            Integer[] elements = { 1, 2, 3 };
            Combinator<Integer> a = new Combinator<>(elements, 2);
        ...
        {
            Integer[] elements = { 1, 2, 3 };
            Combinator<Integer> a = new Combinator<>(elements, 1);
        ...
        {
            Integer[] elements = { 1, 2, 3, 4 };
            Combinator<Integer> a = new Combinator<>(elements, 3);
