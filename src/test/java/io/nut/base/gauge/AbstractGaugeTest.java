...
public class AbstractGaugeTest
{
    ...
    public void testPaint()
    {
        ...
        instance.start();
        instance.setNanos(nanos+JavaTime.NANOS_PER_MILLIS*1000);
        instance.setVal(1);
        instance.pause();
        instance.setNanos(nanos+JavaTime.NANOS_PER_MILLIS*2000);
        instance.resume();
        instance.setNanos(nanos+JavaTime.NANOS_PER_MILLIS*3000);
        instance.setVal(2);
        instance.invalidate();
